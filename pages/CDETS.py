...
st.markdown("<h1 style='text-align: center; color: red;'> CDETS ANALYSIS </h1>", unsafe_allow_html=True) 
...
if uploaded_file:
   ...
   df = pd.read_excel(uploaded_file, engine='openpyxl',sheet_name="CDETS", dtype=str)
   df=df.fillna('') 
